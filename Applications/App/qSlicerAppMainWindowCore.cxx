...
void qSlicerAppMainWindowCore::onHelpKeyboardShortcutsActionTriggered()
{
  ...
  QString appName = "%1 Application";
  actionsDialog.addActions(this->widget()->findChildren<QAction*>(),
    appName.arg(Slicer_MAIN_PROJECT_APPLICATION_NAME));
...
{
  QString url = "http://public.kitware.com/Wiki/%1";
  QDesktopServices::openUrl(QUrl(url.arg(Slicer_MAIN_PROJECT_APPLICATION_NAME)));
}
